                ...
                <table class="result" id="soundReflexTable">
                    ...
                    foreach ($results as $result) { ?>
                        <tr>
                            ...
                            <td><?php echo $result["averageSoundTemperature"];?></td>
                            <td><?php echo $result["averageSoundHeartBeat"];?></td>
                        </tr>
                    <?php }?>
                    ...
                    if(empty($id) == false){ ?>
                        ...
                        while ($i < sizeof($resultArray)){
                            ...
                            <tr>
                                ...
                                <td><?php echo $resultArray[$i][11];?></td>
                                <td><?php echo $resultArray[$i][12];?></td>
                            </tr>
